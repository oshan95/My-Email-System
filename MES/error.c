...
PURPOSE: To handle errors in system calls
...
[2] Stevens, W. Richard, Bill Fenner, and Andrew M Rudoff. 1999. UNIX Network Programming. Appendix D. Miscellaneous Source Code (lib/error.c). 1st ed. Boston: Addison-Wesley/Prentice-Hall.
